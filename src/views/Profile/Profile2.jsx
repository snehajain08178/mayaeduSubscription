  ...
  return (
    <div className="w-100 Views__Profile">
      ...
      <div className="container h-100">
        ...
        >
          <div className="row flex-column Px--40 M pt-lg-5">
          ...
          <div className="d-flex flex-column flex-sm-row justify-content-center w-100">
            <div className="col d-flex align-items-center justify-content-center flex-column">
              <div className="row d-flex align-items-center w-100 Main_View">
            ...
            <div className="col M--50 Border-Radius--30px w-100 P--20 justify-content-between" style={{ backgroundColor: 'white' }}>
              <div className="text-capitalize w-100 P--10 justify-content-between">
                <h5 className="text-primary font-weight-bold">
                  Plan Information:
                </h5>
                <div className="d-flex w-100 flex-column align-self-center justify-content-center Inner_View_Features">
                  <div>
                    ...
                    <div>
                      ...
                      <p>DAYS REMAINING TO AND END</p>
                    </div>
                  </div>
                  <div className="row d-flex justify-content-center align-items-center Mt--20">
                    <div className="row d-flex justify-content-between align-items-center text-white w-75">
                      <Link
                        to={endpoints.plans}
                        className="text-decoration-none text-white"
                      >
              ...
              <div className="text-capitalize w-100 P--10">
                <h5 className="font-weight-bold text-primary">
                  Plan Features
                </h5>
                <div className="d-flex flex-column align-self-center justify-content-center Inner_View_Features">

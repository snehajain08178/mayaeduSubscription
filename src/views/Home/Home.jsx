      ...
      <div className="View__Home__Image__Wrapper">
        <div className="View__Home__Container container">
          <div className="row mx-auto">
            <div className="col-md-9 d-flex justify-content-center justify-content-sm-start flex-column text-center text-md-left align-items-center align-items-md-start View__Home__Container__Left">
              ...
              <span className="mt-4">
                <h4 className="text-white">
                  AI healthcare in your hands, accessible 24/7. Analyze
                </h4>
                <h4 className="text-white">
            ...
            <div className="col-md-3 d-flex justify-content-center justify-content-sm-end mt-4 mt-md-0">
              <CImg src={img.landingMobileImg} width={175} height={350} />
            </div>
          </div>
        </div>
      </div>

...
export const practiceCases = 'Practice Cases From Universities';
...
export const prepareExams = 'Prepare For Exams';
...
export const activeCases1 = 'Brush up your diagnostic skills with cases in real-time.';
export const universityCirculum = 'Based On Your University Curriculum';
export const universityCirculum1 = 'We offer a variety of content based on the requirement of medical students and we can even add your own cases too.';

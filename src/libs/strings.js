...
export const conversationalInterface1 = 'Engages normal patients through normal conversation';
export const conversationalInterface2 = 'Text-based chatbot';
export const clinicalAlgorithms = 'Clinical Algorithms';
export const clinicalAlgorithms1 = 'Artificial intelligence for healthcare';
export const clinicalAlgorithms2 = 'Designed to replicate the logic and diagnostic processes of expert physicians';
...
export const patientDiagnosis = 'Unlimited Patient Diagnosis';
export const patientDiagnosis1 = 'Maya EDU provides a full differential diagnosis engine that can process any number and/or combination of symptoms, signs, labs, tests, medications, past medical history.';
